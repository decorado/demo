 ...
 * @suppress {checkTypes} checked by tsc
 */
var DecListTabsFilter = /** @class */ (function () {
...
var DecListTabsFilterComponent = /** @class */ (function () {
    function DecListTabsFilterComponent(route, router) {
        ...
        this.onSearch = function (uid, recount) {
            ...
            if (_this.filters) {
                var /** @type {?} */ filterTab = _this.filters.find(function (filter$$1) { return filter$$1.uid === uid; });
                if (filterTab) {
                    _this.search.emit({
    ...
    Object.defineProperty(DecListTabsFilterComponent.prototype, "filters", {
        ...
        function (v) {
            if (this._filters !== v) {
                this._filters = v.map(function (filter$$1) { return new DecListTabsFilter(filter$$1); });
            }
        },
        enumerable: true,
        configurable: true
 ...
 * @suppress {checkTypes} checked by tsc
 */
var DecListTabsFilterModule = /** @class */ (function () {
...
var DecListComponent = /** @class */ (function () {
    ...
    */
    ...
    function (filterGroupsModel, payload) {
        var /** @type {?} */ basicSearch = filterGroupsModel.filters.find(function (filter$$1) { return filter$$1.property === 'search'; });
    ...
    function (filterGroups) {
        return filterGroups.find(function (filterGroup) {
            var /** @type {?} */ basicSerchFilter = filterGroup.filters.find(function (filter$$1) { return filter$$1.property === 'search'; });
