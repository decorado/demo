import { Injectable, Component, Input, EventEmitter, Output, ContentChild, TemplateRef, NgModule, ViewChild, ContentChildren, forwardRef, ComponentFactoryResolver, ViewContainerRef, HostListener, Renderer, ElementRef, Directive, Inject, Optional, SkipSelf, InjectionToken, defineInjectable, inject } from '@angular/core';
