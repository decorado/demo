...
export class DecListComponent {
    ...
    loadByOpennedCollapse(filterUid) {
        const /** @type {?} */ filter = this.collapsableFilters.find(item => item.uid === filterUid);
