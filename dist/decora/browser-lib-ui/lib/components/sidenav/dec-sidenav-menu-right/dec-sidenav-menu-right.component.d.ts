import { QueryList, EventEmitter, OnDestroy, AfterViewInit } from '@angular/core';
...
export declare class DecSidenavMenuRightComponent implements AfterViewInit, OnDestroy {
