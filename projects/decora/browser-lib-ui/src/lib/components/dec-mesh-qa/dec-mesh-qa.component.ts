...
const baseUrlWebgl = 'https://s3.amazonaws.com/decora-quality-assurance-mesh/dev/Build';

const meshTest = {
  'editMode ': true,
  'model ': 'http://arquivos.decora/fbx-qa/model.glb ',
  'WireframeTags ': [],
  'MatcapTags ': [],
  'MapTags ': [],
  'MaterialsTags ': [],
...
export class DecMeshQaComponent implements AfterContentChecked {
  ...
  public gameContainerId = `gameContainer${this.uId}`;
  ...
  private SetData(): void {
    this.gameInstance.SendMessage('PageService', 'SetData', JSON.stringify(meshTest));
  }

  private EnableEdit(): void {
    this.gameInstance.SendMessage('PageService', 'EnableEdit', true);
  }
  //// Unity Functions
}
