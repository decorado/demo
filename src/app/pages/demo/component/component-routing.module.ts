...
const routes: Routes = [
  ...
  { path: 'product-info', loadChildren: './decora-product-info-demo/decora-product-info-demo.module#DecoraProductInfoDemoModule' },
  { path: 'round', loadChildren: './decora-job-round-demo/dec-job-round-demo.module#DecJobRoundDemoModule' },
