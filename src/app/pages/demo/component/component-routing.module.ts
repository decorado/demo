...
const routes: Routes = [
  ...
  { path: 'autocomplete-product-category', loadChildren: './decora-autocomplete-product-category-demo/decora-autocomplete-product-category-demo.module#DecoraAutocompleteProductCategoryDemoModule' },
  ...
  { path: 'input-time', loadChildren: './decora-input-time-demo/decora-input-time-demo.module#DecoraInputTimeDemoModule' },
